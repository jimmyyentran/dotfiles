...
beautiful.hotkeys_font = "Liberation 40"
...
globalkeys = my_table.join(
    ...
    awful.key({  }, "XF86MonBrightnessUp",
            function ()
                ...
                awful.util.spawn("volnoti-brightness.sh")
            end),
    ...
    awful.key({ "Shift" }, "XF86MonBrightnessUp",
            function ()
                awful.util.spawn("light -A 20")
                awful.util.spawn("volnoti-brightness.sh")
            end),
    awful.key({ "Shift" }, "XF86MonBrightnessDown",
            function ()
                awful.util.spawn("light -U 20")
                awful.util.spawn("volnoti-brightness.sh")
            end),
    ...
    awful.key({  }, "XF86AudioRaiseVolume",    function () awful.util.spawn("volume_up.sh 5") end),
    awful.key({  }, "XF86AudioLowerVolume",    function () awful.util.spawn("volume_down.sh 5") end),
    awful.key({ "Shift" }, "XF86AudioRaiseVolume",    function () awful.util.spawn("volume_up.sh 20") end),
    awful.key({ "Shift" }, "XF86AudioLowerVolume",    function () awful.util.spawn("volume_down.sh 20") end),
    awful.key({  }, "XF86AudioMute",    function () awful.util.spawn("volume_mute.sh") end),
    ...
    --]]
    awful.key({ modkey }, "p", function() awful.spawn.with_shell("rofi -combi-modi run,drun -show combi -modi combi") end,
    ...
    --]]
    awful.key({ "Control" }, "space", function () awful.util.spawn("rofi_window.sh") end),
