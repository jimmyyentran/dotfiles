...
-- Override eventtap to go faster
hs.eventtap.keyStroke = function(modifiers, character)
...
normalActivationListener = eventtap.new({ eventTypes.keyDown }, function(event)
...
-- Context {{{3
normal:bind({'ctrl'}, 'space', function()
    hs.eventtap.keyStroke({"ctrl"}, "space") -- call Context
    normal:exit()
    hs.alert.show('Insert mode')
end)
-- }}}3
...
normal:bind({}, '/', function()
    normal:exit()
    hs.eventtap.keyStroke({"cmd"}, "f") end)
-- }}}2
